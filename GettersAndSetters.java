...
public class GettersAndSetters {
    ...
    public GettersAndSetters(String text,String file) {
        ...
        frame = new JFrame("Getters & Setters");
    ...
    public void setOnClickListeners(){
        ...
        buttonApply.addActionListener(e -> {
            String gettersAndSetters = getGettersAndSetters();

            String outputFile = file.replace(text,text+gettersAndSetters+"\n");
            Notepad notepad = new Notepad();
            notepad.setText(outputFile);
            frame.dispatchEvent(new WindowEvent(frame, WindowEvent.WINDOW_CLOSING));
    ...
    public String getGettersAndSetters(){
        ...
        for(int i=0; i<checkBox.length; i++){
            if(checkBox[i].isSelected()){
                gettersAndSetters += getGetter(i);
                gettersAndSetters += getSetter(i)+"\n";
            }
        }
