...
public class Constructor {
    ...
    JCheckBox checkBox[],checkBoxSelectAll,checkBoxDefault;
    ...
    final static Font tempF = new Font("Monospaced", Font.PLAIN, 18);


    public Constructor(String className,String text,String file) {
        ...
        frame = new JFrame("Constructor");
        checkBoxDefault = new JCheckBox(" Default Constructor");
        checkBoxDefault.setFont(defaultFont);
        panel = new JPanel(new GridLayout(15,0));
        ...
        panel.add(checkBoxDefault);
        panel.add(new Label("---------------------------------------------------------------"));
        JLabel label = new JLabel("Parameterized Constructor");
        label.setFont(tempF);
        panel.add(label);
    ...
    public void setOnClickListeners(){
        ...
        buttonApply.addActionListener(e -> {
            ...
            if(checkBoxDefault.isSelected()){
                ...
                String body = "";
                for(int i=0; i< variables.length; i++){
                    param += dataTypes[i]+" "+variables[i]+" , ";
                    body += "\n\t\tthis."+variables[i]+ " = "+ variables[i];
                }
                constructor = "\tpublic "+className+"("+param+"){"+"\n"+
                                body+"\n"+
                                "\n\t}";
            }
    ...
    public String getParamConstructor(){

        String paramCons = "\n";

        for(int i=0; i<checkBox.length; i++){
            if(checkBox[i].isSelected()){
                paramCons += getSetter(i);
            }
        }
